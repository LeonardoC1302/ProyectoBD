...
$router->post('/account', [PagesController::class, 'account']);
...
$router->post('/orderReport', [HelpController::class, 'report']);
$router->get('/clients/consults', [HelpController::class, 'consult']);
$router->post('/clients/consults', [HelpController::class, 'consult']);
